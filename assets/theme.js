...
slate.Variants = (function() {
  ...
  function Variants(options) {
    ...
    this._filterThumbnails(this.currentVariant.option2);
  ...
  Variants.prototype = _.assignIn({}, Variants.prototype, {
    ...
    _filterThumbnails: function(variant) {
      var colorAttr = $('li.product-single__thumbnails-item').attr('data-product-color');

      // console.log(colorAttr);
      // $( "li.product-single__thumbnails-item").each(function() {
      //   if(product.featured_image != null && variant.featured_image.alt != null) {
      //     $('this').css({'display': 'none !important'});
      //     var color = variant.featured_image.alt;
      //     var thumbnail_selector =  $('this').attr('data-product-color');
      //     console.log(color);
      //     console.log(thumbnail_selector);
      //   } 
      // });
    },
...
theme.Product = (function() {
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _initThumbnailSlider: function() {
      ...
      $(this.selectors.productThumbs).slick('slickGoTo', 0);

      console.log($(this.selectors.productThumbs));
...
$(document).ready(function() {
  ...
  //     if ($('#shopify-section-product-recommendations').isInViewport()) {
  //       $('.product_details').css({'position': 'relative'});
  //       $('.product-single__meta').css({'margin': '0'});
  //     }
  //     else {
  //       $('.product_details').css({'position': 'fixed'});  
  //       $('.product-single__meta').css({'margin': '130px 0 0 0'});
  //     }
  //   });
  // };

  // var cartCount =  $('.site-header__cart-count').text();

  // if(cartCount >= 1 ) {
  //   console.log('Cart icon equals 1');
  // }
  ...
  $('.shop_nav').click(function() {
    $(this).toggleClass('show');
    $(this).find('ul').toggle();
    $(this).find('span.arrow svg').toggleClass('flip');
  });

  var currentCol = $('.shop_nav p.current_collection').text();
  var items = $(".shop_nav ul li a");
  items = items.text();
  
  for (var i = 0; i < items.length; ++i) {
    if(currentCol === items[i].innerHTML) {
      $(items).css({'display': 'none !important'});
    }
  }

  if ($(window).width() <= 990) {
    $('.accounts_nav').click(function() {
      $(this).toggleClass('show');
      $(this).find('ul').toggle();
      $(this).find('span.arrow svg').toggleClass('flip');
    });

    var currentPage = $('.accounts_nav p.current_page').text();
    var items = $(".accounts_nav ul li a");
    items = items.text();
    
    for (var i = 0; i < items.length; ++i) {
      if(currentPage === items[i].innerHTML) {
        $(items).css({'display': 'none !important'});
      }
    }
  }
  ...
  if ($(window).width() <= 991) {
    $('.stay_updated').click(function() {
      $('.site-footer__newsletter').slideUp();
      if ($(this).next().is(":hidden")) {
        $(this).next().slideDown();
        // $(this).css({'margin-bottom': '20px'});
        // $(this).next().css({'margin': '20px 0 0 13px'});
      }
    });

    $('.links_wrapper p').click(function() {
      $('span.black_arrow').removeClass('flip_arrow');
      $('.links_wrapper ul').slideUp();
      if ($(this).next().is(":hidden")) {
        $(this).next().slideDown();
        $(this).find('span.black_arrow').addClass('flip_arrow');
        // $(this).css({'margin-bottom': '20px'});
        // $(this).next().css({'margin': '20px 0 0 13px'});
      }
      else {
  ...
  if ($(window).width() > 1200) {
    $('.details_wrapper').click(function(e) {
      e.preventDefault();
      $('.more_details').css({'border-left': '1px solid #000000'});
      if($(e.target).hasClass('show_sizing')) {
        $(this).find('p.title').css({'text-decoration': 'underline'});
        $('.more_details .show_sizing').show();
      }
      else {
        $('.more_details .show_sizing').hide();
        $('p.title').css({'text-decoration': 'none'});   
      }
    });

    $('.details_wrapper').click(function(e) {
      if($(e.target).hasClass('show_products')) {
        $(this).find('p.title').css({'text-decoration': 'underline'});
        $('.more_details .show_products').show();
      }
      else {
        $('.more_details .show_products').hide();
        $('p.title').css({'text-decoration': 'none'});   
      }
    });
  ...
  if ($(window).width() <= 1200) {
    $('.details_wrapper .title_wrapper').click(function() {
      $('.black_arrow svg').removeClass('flip_arrow');
      $('.details_wrapper .content').slideUp();
      if ($(this).next().is(":hidden")) {
        $(this).next().slideDown();
        $(this).find('.black_arrow svg').addClass('flip_arrow');
      }
      else {
        $(this).find('.black_arrow svg').removeClass('flip_arrow');
      }
    });
  }

  if ($(window).width() <= 767) {
    // var first_product = $('li.slick-active').attr('[tabindex="-1"]');
    // first_product.parent.css({'width':'100% !important'});
  }
  ...
  if ($(window).width() <= 749) {
    $('.desktop-form').remove();
    $('.select-size a').click(function() {
      $('.size-select-wrap').addClass('show');
    ...
    $('.size-row .sizes').click(function() {
      ...
      $('.size-row .sizes').removeClass('underline');
      $(this).each(function(i) {
      const sizeOptions = $(this)[i];
        if($(this).text() === $.trim(size)) {
          $(sizeOptions).addClass('underline');
        }
      });
      $(".measurement-wrap").each(function(i) {
        if($(this).attr('data-size') === $.trim(size)) {
          const chart = $(sizeChart)[i];
          $(chart).toggleClass('show');
        }
      });
    });

    $('.size-select-wrap label').click(function() {
      const sizeSelected = $(this).text();
      $('.select-size .btn').html(sizeSelected);
      $('.size-select-wrap').removeClass('show');
      ...
      $(".size-row .sizes").each(function(i) {
        console.log($(this).text());
        if($(this).text() === $.trim(size)) {
          const sizeOption = $(".size-row .sizes")[i];
          $(sizeOption).toggleClass('underline');
        }
      });
      if(disabledBtn) {
  ...
  function autocomplete(inp, arr) {
    ...
    inp.addEventListener("input", function(e) {
        ...
        document.getElementById('country-field').appendChild(a);
  ...
  // if ($(window).width() >= 750) {
  //   $('a.site-header__cart').hover(function() {
  //     console.log('Hovered!');
  //     $('.cart-popup-wrapper').css({'transform':'translateY(0%)'});
  //   });
    
  //   $('.cart-popup__close').click(function() {
  //     $('.cart-popup-wrapper').css({'transform':'translateY(-170%)'});
  //   });
  // }

  // if($('span.cart_count').text() === '00' || $('span.cart_count').text() === undefined || $('span.cart_count').text() === null) {
  //   console.log('Cart equals 0');
  //   $('.cart-popup-item').css({'display': 'none'});
  // }
  // if($('span.cart_count').text() === '1' || $('span.cart_count').text() >= 1 ) {
  //   console.log('Cart equals 1');
  //   $('.cart-popup-item').css({'display': 'flex'});
  // }

  // if ($(window).width() > 749) {
  //   $('.site-header__cart').mouseover(function(){
  //     console.log('Hello!');
  //     $('.cart-popup-wrapper').show();
  //   });
  //   $('.site-header__cart').mouseout(function(){
...
$(document).ready(function() {
  ...
  var $window = $(window),
      ...
      $productDetailsAnchor = $('.details_anchor');

  // Run this on scroll events.
  $window.scroll(function() {
      var window_top = $window.scrollTop();
      var div_top = $productDetailsAnchor.offset().top;
      if (window_top > div_top) {
          // Make the div sticky.
          $productDetails.addClass('stick');
          $productDetailsAnchor.height($productDetails.height());
      }
      else {
          // Unstick the div.
          $productDetails.removeClass('stick');
          $productDetailsAnchor.height(0);
      }
  });
});
...
//   const prompt = document.getElementById('age-check-prompt'),
//     agePrompt = localStorage.getItem('agePrompt'),
...
//         date1_ms = new Date(first).getTime(),
//         date2_ms = new Date(second).getTime(),

//         // Calculate the difference in milliseconds
//         difference_ms = date2_ms - date1_ms;

//       // Convert back to days and return
//       return Math.round(Math.abs(difference_ms / one_day));

//     };
//   if (rememberMeVal) {
//     if (datediff(new Date(), rememberMeVal) > 30) {
...
window.onload=function () {
  ...
  function validate() {
    ...
    if (validateEmail(email)) {
      $('p.message_success').show();
      $('p.message_error').hide();
      close_pop();
    } else {
      $('p.message_error').show();
      $('p.message_success').hide();
    }
    return false;
  }
  
  $("#popup-subscribe").on("click", validate);

  if (!getCookie('hide')) {
      window.setTimeout(function () {
          //$('.popup_wrap').show();
          $('.popup_wrap').ready(function () {
              $('.popup_wrap').animate({
                  'opacity': '1.00',
                  'display': 'flex'
              }, 300, 'linear');
...
// document.addEventListener('DOMContentLoaded', function () {
//   const prompt = document.getElementById('popup_wrap'),
//     agePrompt = localStorage.getItem('agePrompt'),
//     rememberMeVal = localStorage.getItem('rememberMeVal'),
//     datediff = function (first, second) {
//       //Get 1 day in milliseconds
...
//   document.getElementById('popup_wrap').addEventListener('click', function (e) {
//     $(this).hide();
//     // if($('input#yes').is(':checked')) {
//       localStorage.setItem('agePrompt', true);
//       // if (document.getElementById('remember-me').checked) {
